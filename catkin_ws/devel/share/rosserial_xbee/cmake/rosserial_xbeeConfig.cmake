...
if("TRUE" STREQUAL "TRUE")
  set(rosserial_xbee_SOURCE_PREFIX /home/haha/catkin_ws/src/rosserial/rosserial_xbee)
  set(rosserial_xbee_DEVEL_PREFIX /home/haha/catkin_ws/devel)
  ...
  set(rosserial_xbee_INSTALL_PREFIX /home/haha/catkin_ws/install)
...
if(NOT "" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'rosserial_xbee' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/haha/catkin_ws/src/rosserial/rosserial_xbee/${idir}'.  Ask the maintainer 'Paul Bouchier <paul.bouchier@gmail.com>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  list(APPEND rosserial_xbee_LIBRARIES ${${rosserial_xbee_dep}_LIBRARIES})
...
if(rosserial_xbee_LIBRARIES)
  _remove_duplicate_libraries(rosserial_xbee_LIBRARIES rosserial_xbee_LIBRARIES)
endif()
