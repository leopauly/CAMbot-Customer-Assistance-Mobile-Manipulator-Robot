...
if("TRUE" STREQUAL "TRUE")
  set(rosserial_windows_SOURCE_PREFIX /home/haha/catkin_ws/src/rosserial/rosserial_windows)
  set(rosserial_windows_DEVEL_PREFIX /home/haha/catkin_ws/devel)
  ...
  set(rosserial_windows_INSTALL_PREFIX /home/haha/catkin_ws/install)
...
if(NOT "" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'rosserial_windows' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/haha/catkin_ws/src/rosserial/rosserial_windows/${idir}'.  Ask the maintainer 'Kareem Shehata <kshehata@clearpathrobotics.com>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  list(APPEND rosserial_windows_LIBRARIES ${${rosserial_windows_dep}_LIBRARIES})
...
if(rosserial_windows_LIBRARIES)
  _remove_duplicate_libraries(rosserial_windows_LIBRARIES rosserial_windows_LIBRARIES)
endif()
